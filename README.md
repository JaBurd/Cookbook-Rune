...
Deploys a collection of build artifacts from artifactory. Artifacts are extracted from
the package and managed in a deploy directory.
...
artifactory_url            | Artifact URL in artifactory                                                          | String  |
...
after_extract              | A proc containing resources to be executed after the artifact package is extracted   | Proc    |
